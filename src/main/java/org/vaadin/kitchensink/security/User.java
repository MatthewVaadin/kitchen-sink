 ...
 * created through the {@link #builder()} method and customized using the fluent {@link UserBuilder} API.
 * </p>
 * <p>
 ...
 * </p>
 *
 * @see UserBuilder The builder for creating DevUser instances
 ...
 */
public final class User implements AppUserPrincipal, UserDetails {

    private final AppUserInfo appUser;
    private final Set<GrantedAuthority> authorities;
    private final String password;

    User(AppUserInfo appUser, Collection<GrantedAuthority> authorities, String password) {
     ...
     * be provided before calling {@link UserBuilder#build()}.
     * </p>
     *
    ...
    /**
     * Builder for creating {@link User} instances with customized properties.
     * <p>
    ...
    static final class UserBuilder {
         ...
         * @return this builder for method chaining
         */
        public UserBuilder fullName(@Nullable String fullName) {
         ...
         * @return this builder for method chaining
         */
        public UserBuilder profileUrl(@Nullable String profileUrl) {
         ...
         * @return this builder for method chaining
         */
        public UserBuilder pictureUrl(@Nullable String pictureUrl) {
         ...
         * @return this builder for method chaining
         */
        public UserBuilder zoneInfo(ZoneId zoneInfo) {
        ...
        public User build() {
            ...
            return new User(new UserInfo(userId, preferredUsername, fullName, profileUrl, pictureUrl, email,
