 ...
 * </p>
 * <p>
 * The class provides both the complete {@link User} objects (for use in user details services) and individual
 ...
 * </p>
 *
 * @see User The development user implementation
 * @see DefaultUserDetailsService The service that uses these sample users
 */
public final class SampleUsers {
     ...
     * </p>
     */
    static User ADMIN = User.builder().preferredUsername(ADMIN_USERNAME).fullName("Alice Administrator")
     ...
     * </p>
     */
    static final User USER = User.builder().preferredUsername(USER_USERNAME).fullName("Ursula User")
     ...
     * creating a {@link DefaultUserDetailsService} that should include all available test users. Using this list ensures
     ...
     * </p>
     */
    static final List<User> ALL_USERS = List.of(USER, ADMIN);
}
