 ...
 * collection of {@link User} instances and allows looking them up by preferred username.
 * </p>
 * <p>
 ...
 * </p>
 *
 * @see User The development user class stored in this service
...
public class DefaultUserDetailsService implements UserDetailsService {
    ...
    /**
     * Creates a new service with the specified users.
     * <p>
     * This constructor stores the provided users in memory, indexing them by preferred username for efficient lookups.
     * </p>
     *
     * @param users
     *            the users to include in this service
     */
    DefaultUserDetailsService(Collection<User> users) {
