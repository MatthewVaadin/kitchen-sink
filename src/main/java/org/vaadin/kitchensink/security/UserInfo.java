...
/**
 * Implementation of {@link AppUserInfo} used by {@link User} for development environments.
 * <p>
 ...
 * production. It's primarily used by the {@link User} class to represent test user information.
 * </p>
 *
 * @param userId
 ...
 * @see User The development user class that uses this record
 * @see AppUserInfo The interface this record implements
 */
record UserInfo(UserId userId, String preferredUsername, String fullName, @Nullable String profileUrl,
